...
namespace EventRegistrationApplication.Data
{
    public class EventRegistrationApplicationContext(DbContextOptions<EventRegistrationApplicationContext> options) : IdentityDbContext<EventRegistrationApplicationUser>(options)
    {
        ...
        public DbSet<EventRegistrationApplication.Domain.SeatStatusModel> SeatStatuses { get; set; } = default!;
        public DbSet<EventRegistrationApplication.Domain.SeatSelection> SeatSelections { get; set; } = default!;
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new SeatStatusSeed());
